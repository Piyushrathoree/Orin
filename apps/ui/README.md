Orin is the active Next.js frontend. The marketing landing page, authenticated dashboard, collaborative editor, Clerk authentication, and WebContainers all run from this package. AI requests are proxied to `apps/orin-backend`.
